...
class SwitchKidsAccount extends StatefulWidget {
  const SwitchKidsAccount({super.key});

  @override
  State<SwitchKidsAccount> createState() => _SwitchKidsAccountState();
}

List<Map<String, String>> arrayOfKids = [
  {'name': 'Parent Name', 'imageAssets': "assets/images/37.png"},
  {'name': "Maman's Name", 'imageAssets': "assets/images/37.png"},
];

class _SwitchKidsAccountState extends State<SwitchKidsAccount> {
  @override
